...
config.name = "mlir_start"
config.test_format = ShTest()
config.suffixes = [".mlir"]

# lit executes relative to the directory
#
#   bazel-bin/tests/<test_target_name>.runfiles/mlir_start/
#
...
#
# Bazel defines RUNFILES_DIR which includes mlir_start/ and third party
# dependencies as their own directory. Generally, it seems that $PWD ==
# $RUNFILES_DIR/mlir_start/
