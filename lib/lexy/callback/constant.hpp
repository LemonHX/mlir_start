...
namespace lexy {
template <typename T> struct _constant {
  T _value;
...
/// Creates a callback that produces the given value without accepting
/// arguments.
template <typename Arg> LEXY_CONSTEVAL auto constant(Arg &&value) {
